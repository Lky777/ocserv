...
#Default_Ask "what's your name?" "Lky777" "The_name"
#echo $The_name
...
#custom-configuration or not 自定义安装与否
    fast_Default_Ask "Install ocserv with Custom Configuration?(y/n)" "y" "Custom_config_ocserv"
    clear && print_xxxx
...
#sources check
    source_stretch_backports="y" && source_buster="y"
    character_Test "/etc/apt/sources.list" "stretch-backports" || source_stretch_backports="n"
    character_Test "/etc/apt/sources.list" "buster" || source_buster="n"
...
EOF
    oc_dependencies="libprotobuf-c-dev libgnutls28-dev gnutls-bin libseccomp-dev libhttp-parser-dev libkrb5-dev openssl autogen gperf pkg-config make gcc m4 build-essential libgmp3-dev libwrap0-dev libpam0g-dev libdbus-1-dev libnl-route-3-dev libopts25-dev libnl-nf-3-dev libreadline-dev libpcl1-dev libtalloc-dev libev-dev liboath-dev"
    TEST_S=""
    Dependencies_install_onebyone   
...
function help_ocservauto(){
    ...
    echo
    print_info " install ----------------------- Install ocserv for Debian 10+"
    echo
...
echo "==============================================================================================="
echo
print_info " System Required:  Debian 10+"
echo
print_info " Desc:  Install OpenConnect VPN server"
echo
